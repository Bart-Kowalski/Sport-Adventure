...
class Registration
{
    ...
    public function run($form)
    {
        ...
        $user_role            = isset($form_settings['registrationUserRole']) ? $form->get_form_field_by_id($form_settings['registrationUserRole']) : false;
        $send_email_to_user   = isset($form_settings['sendEmailToUser']) ? $form->get_form_field_by_id($form_settings['sendEmailToUser']) : false;
        // Form validation
